    ...
    render () {
        return (
            <div className="buttons">
                <button className="color-2 uppercase" onClick={this.handleOpenModal}>вход</button>
                <ReactModal
                ...
                >
                    <div className='check_in_button'>
                        <div className="ai-c flex-d_c">
                            <h2 className="color-1">вход</h2>
                            <input placeholder="Логин" type="text"/>
                            <input placeholder="Пароль" type="text"/>
                            <img className="bg" src={Home_b} alt=""/>
                        </div>
                        <button className="REGISTER uppercase color-w background-1">вход</button>
